...
// function checkDog(mov, i) {
//   mov > 3
//     ? console.log(`Dog number ${i + 1} is an adult, and is ${mov} years old.`)
//     : console.log(
//         `Dog number ${i + 1} is still a puppy, and is ${mov} ${
//           mov > 1 ? 'years' : ' year'
//         } old.`
//       );
// }
...
// const juliaFinal = juliaDog.slice(1, 3);

// console.log("JULIA's DOG");
// juliaFinal.forEach(function (mov, i) {
//   checkDog(mov, i);
// });
// console.log("KATE's DOG");
// kateDog.forEach(function (mov, i) {
//   checkDog(mov, i);
// });
